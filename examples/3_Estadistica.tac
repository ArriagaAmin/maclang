...
@string S5 "0000-"
@string S6 "0000."
@string S7 "0000Desea iniciar un calculo estadistico? [Y\n] "
@string S8 "0000Hasta luego!"
@string S9 "0000Indique el numero de muestras: "
@string S10 "0000Indique las %i muestras: "
@string S11 "0000Cantidad de muestras: %i."
@string S12 "0000Promedio: %f."
@string S13 "0000Varianza: %f."
@string S14 "0000Desviacion estandar: %f."
@string S15 "0000Minimo: %f."
@string S16 "0000Maximo: %f."
assignw NULL 0
assignw T0 1
@function READ 4
assignw T1 BASE[0]
...
add T759 T759 4
malloc T757 T759
memcpy T757 T738 T759
param T760 0
assignw T760[0] T757
param T761 4
assignw T761[0] T712
call f71 Function4 2
assignw T762 1
assignw T764 T762
assignw T765 4
mult T765 T765 T764
...
add T775 T775 4
malloc T773 T775
memcpy T773 T738 T775
param T776 0
assignw T776[0] T773
param T777 4
assignw T777[0] T712
call f72 Function7 2
assignw T778 1
assignw T780 T778
assignw T781 4
mult T781 T781 T780
...
add T791 T791 4
malloc T789 T791
memcpy T789 T738 T791
param T792 0
assignw T792[0] T789
param T793 4
assignw T793[0] T712
call f73 Function8 2
assignw T794 1
assignw T796 T794
assignw T797 4
mult T797 T797 T796
...
add T807 T807 4
malloc T805 T807
memcpy T805 T738 T807
param T808 0
assignw T808[0] T805
param T809 4
assignw T809[0] T712
call f74 Function5 2
assignw T810 1
assignw T812 T810
assignw T813 4
mult T813 T813 T812
...
add T823 T823 4
malloc T821 T823
memcpy T821 T738 T823
param T824 0
assignw T824[0] T821
param T825 4
assignw T825[0] T712
call f75 Function6 2
assignw T826 1
assignw T828 T826
assignw T829 4
mult T829 T829 T828
