...
@string S5 "0000-"
@string S6 "0000."
@string S7 "0000Indique el numero en punto flotante no negativo: "
@string S8 "0000sqrt(%i) = %f"
@string S9 "0000Desea calcular otra raiz? [Y/n] "
@string S10 "0000Hasta luego!"
assignw NULL 0
assignw T0 1
@function READ 4
assignw T1 BASE[0]
